...
const GuideCard = ({ guide }) => {
    ...
    return (
        ...
        <div className="flex flex-col justify-center max-w-xs p-2 shadow-md rounded-xl sm:px-2 bg-gray-50 text-gray-800 transform transition duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <div className="space-y-4 text-center">
                ...
                <div className="divider">
                    <button className="btn bg-primary-color btn-xs text-white font-bold transition duration-300 hover:bg-secondary-color">See Details</button>
                </div>
            </div>
        </div>

        // <div className="flex flex-col justify-center max-w-xs p-2 shadow-md rounded-xl sm:px-2 bg-gray-50 text-gray-800">
        ...
        //             <p className="px-5 text-xs sm:text-base dark:text-gray-600">Tourist Guide</p>
        //         </div>
        //         <div className="divider"><button className="btn bg-primary-color btn-xs text-white font-bold">See Details</button></div>
        //     </div>
        // </div>
    );
};
